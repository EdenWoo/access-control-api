...
| /order?f_name=xx                                | /order?f_name=xx&f_name=LIKE                              | 默认op为LIKE                                |
| /order?f_name=xx&f_name==                       |                                                           |                                             |
| /order?f_date=2017-01-01&f_type=2017-02-01      | /order?f_type=2017-01-01&f_type=2017-02-01&f_type=between | 字段有2个，默认op为between,通常用于时间查询 |
| /order?f_type=1&f_type=2&f_type=3               | /order?f_type=1&f_type=2&f_type=3&f_type_op==             | 字段有3个的时候，默认op为in                 |
