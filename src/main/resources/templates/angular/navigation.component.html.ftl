    ...
    <nav>
        ...
        <#--<ul saSmartMenu>-->
            ...
            <#--<li routerLinkActive="active">-->
                <#--<a routerLink="/outlook" title="Outlook">-->
                    <#--<i class="fa fa-lg fa-fw fa-inbox"></i> <span-->
                        <#--class="menu-item-parent">{{'Outlook' | i18n}}</span><span-->
            ...
            <#--<li>-->
                ...
                <#--<ul>-->
                    ...
                    <#--<li>-->
                        ...
                        <#--<ul>-->
                            <#--<li routerLinkActive="active">-->
                                <#--<a routerLink="/ui/icons/font-awesome"><i class="fa fa-plane"></i> {{'Font Awesome' |-->
                                    <#--i18n}}</a>-->
                            <#--</li>-->
                            <#--<li routerLinkActive="active">-->
                            ...
                            <#--<li>-->
                                ...
                                <#--<ul>-->
                                    <#--<li>-->
                                        ...
                                        <#--<ul>-->
                                            <#--<li>-->
                                                <#--<a href="#"><i class="fa fa-fw fa-file-text"></i> {{'Item#2.1.1' |-->
                                                    <#--i18n}}</a>-->
                                            <#--</li>-->
                                            <#--<li>-->
            ...
            <#--<li>-->
                ...
                <#--<ul>-->
                    ...
                    <#--</li>-->
                    <#--<li routerLinkActive="active">-->
                        <#--<a routerLink="/maps"><i class="fa fa-lg fa-fw fa-map-marker"></i> <span-->
                                <#--class="menu-item-parent">{{'GMap Skins' | i18n}}</span><span-->
            ...
            <#--<li>-->
                ...
                <#--<ul>-->
                    ...
                    <#--</li>-->
                    <#--<li routerLinkActive="active">-->
                        <#--<a routerLink="/e-commerce/product-details" title="Products Detail"> {{'Products Detail' |-->
                            <#--i18n}}</a>-->
                    <#--</li>-->
                <#--</ul>-->
            <#--</li>-->
        ...
        <ul saSmartMenu>
           <#list project.entities as e>
                <li>
                    <a routerLink="/pages/${Utils.lowerHyphen(e.name)}/list" title="${Utils.upperCamel(e.name)}"><i class="fa fa-lg fa-fw fa-home"></i> <span
                            class="menu-item-parent">{{'${Utils.upperCamel(e.name)}' | i18n}}</span></a>
                </li>
            </#list>
