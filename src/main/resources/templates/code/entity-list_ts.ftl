            ...
            <article class="col-sm-12 col-md-12 col-lg-12">
                <sa-widget [editbutton]="false" color="greenLight">
                    <header>
                        ...
                        <h2>${entity} Table</h2>
                        <!--<h2>{{selectedRole !== undefined ? selectedRole.name: ''}}</h2>-->
                    </header>
                    <div>
                        <div class="widget-body no-padding">
                            <div class=""
                                ...
                                <a class="btn btn-default" routerLink="/pages/${entity}-add"><i
                                ...
                                <table class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox">
                                    ...
                                    <#list fields as f>
                                        <th class="hasinput" [ngStyle]="{width:'8%'}">
                                            <input formControlName="${f.name}" type="text" class="form-control"
                                                   placeholder="${f.name}"/>
                                        </th>
                                    </#list>
                                        <th></th>
                                    ...
                                    <#list fields as f>
                                        ...
                                        <td> <a routerLink="/pages/${entity}s/edit/{{item.id}}"><i
